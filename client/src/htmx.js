var htmx = (function () {
  ...
  function makeFragment(response) {
    ...
    if (startTag === "html") {
      ...
      fragment =
        /** @type DocumentFragmentWithTitle */ doc.querySelector(
          "template",
        ).content;
  ...
  function maybeSetLastButtonClicked(evt) {
    const elt = /** @type {HTMLButtonElement|HTMLInputElement} */ closest(
      asElement(evt.target),
  ...
  function addRequestIndicatorClasses(elt) {
    let indicators = /** @type Element[] */ findAttributeTargets(
      elt,
      "hx-indicator",
    );
    if (indicators == null) {
  ...
  function disableElements(elt) {
    let disabledElts = /** @type Element[] */ findAttributeTargets(
      elt,
      "hx-disabled-elt",
    );
